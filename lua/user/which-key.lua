...
local mappings = {
	...
	l = {
		...
		k = { "<cmd>Lspsaga diagnostic_jump_prev<cr>", "Diagnostics Prev" },
	...
	t = {
		...
		w = { "<cmd>lua _PWSH_TOGGLE()<cr>", "PowerShell 1" },
		e = { "<cmd>lua _PWSH_TOGGLE()<cr>", "PowerShell 2" },
		g = { "<cmd>lua _BASH_TOGGLE()<cr>", "Git windows" },
